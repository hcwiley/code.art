...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ExternalId.type'
        db.alter_column('developer_externalid', 'type', self.gf('django.db.models.fields.CharField')(max_length=20))


    def backwards(self, orm):
        
        # Changing field 'ExternalId.type'
        db.alter_column('developer_externalid', 'type', self.gf('django.db.models.fields.CharField')(max_length=1))
