...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('oauth2_lite_client_provider', (
        ...
        db.send_create_signal('oauth2_lite_client', ['Provider'])

        # Adding model 'Credential'
        db.create_table('oauth2_lite_client_credential', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('provider', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['oauth2_lite_client.Provider'])),
        ...
        db.send_create_signal('oauth2_lite_client', ['Credential'])


    def backwards(self, orm):
        
        # Deleting model 'Provider'
        db.delete_table('oauth2_lite_client_provider')

        # Deleting model 'Credential'
        db.delete_table('oauth2_lite_client_credential')
    ...
    complete_apps = ['oauth2_lite_client']
