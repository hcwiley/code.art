...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('post_link', 'title', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Link.title'
        db.delete_column('post_link', 'title')
    ...
    models = {
        ...
        'developer.developer': {
            ...
            'bitbucket_id': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
