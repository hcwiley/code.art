...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('project_media', 'image', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['project.ExtendedImage'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Media.image'
        db.delete_column('project_media', 'image_id')
