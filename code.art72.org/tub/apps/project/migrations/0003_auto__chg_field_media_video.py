...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Media.video'
        db.alter_column('project_media', 'video', self.gf('django.db.models.fields.URLField')(max_length=400, null=True))


    def backwards(self, orm):
        
        # Changing field 'Media.video'
        db.alter_column('project_media', 'video', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))
