...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Developer.process'
        db.add_column('developer_developer', 'process', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Developer.process'
        db.delete_column('developer_developer', 'process')
