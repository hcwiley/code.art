...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('developer_developer', 'image')


    def backwards(self, orm):
        
        # Adding field 'Developer.image'
        db.add_column('developer_developer', 'image', self.gf('sorl.thumbnail.fields.ImageField')(max_length=100, null=True, blank=True), keep_default=False)
