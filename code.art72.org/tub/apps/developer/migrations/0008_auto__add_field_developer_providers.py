...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Developer.providers'
        db.add_column('developer_developer', 'providers', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Developer.providers'
        db.delete_column('developer_developer', 'providers')
